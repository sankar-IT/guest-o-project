...
const OrderReview = () => {
  ...
  const { getCartForTable, updateQuantity, clearTableCart } = useCart();
  const tableCartData = getCartForTable(tableId);
  
  const cart = tableCartData.cart;
  const customerCount = tableCartData.customerCount || location.state?.customerCount || 1;
  const orderNumber = tableCartData.orderNumber || location.state?.orderNumber || `ORD-${Math.floor(1000 + Math.random() * 9000)}`;
  ...
  const updateQty = (id, delta) => {
    updateQuantity(tableId, id, delta);
  };
          ...
          <div className="header-left">
            ...
            <div className="header-title-group">
              ...
              <div className="header-meta">
                <span className="table-badge">Table {tableData?.tableNumber || tableNumberFromState || '00'}</span>
          ...
          <div className="review-side-panel">
            ...
            <div className="action-buttons-stack">
              ...
              <button
                ...
                onClick={() => navigate(`/waiter/tables/${tableId}`)}
              >
