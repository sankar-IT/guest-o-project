...
const TableDetailedView = () => {
  ...
  const handleCreateOrder = () => {
    navigate(`/order/${tableId}?newOrder=true&customers=${newOrderCount}`);
  };
  ...
  return (
    <div className="dashboard-layout">
      <Sidebar />
      <main className="dashboard-main detailed-view">
        <header className="detailed-header">
          <div className="header-left">
            <button className="back-btn" onClick={() => navigate('/staff/tables')}>
              <ArrowLeft size={20} />
            </button>
          ...
          <div className="active-orders-column">
            ...
            <div className="orders-stack">
              {orders.map((order) => {
                ...
                return (
                  <div key={order._id} className="dinesync-card order-card-modern">
                      ...
                      <div className="order-info">
                        <div className="id-status">
                          ...
                          <div className="status-selector-container">
                            <select 
                              className={`status-pill-select ${(order.orderStatus || order.status || '').toLowerCase()}`}
                    ...
                    <div className="order-card-actions">
                      <button 
                        ...
                        onClick={() => navigate(`/staff/order-details/${tableId}/${order._id}`)}
                      >
                        Edit Order
                      </button>
                    </div>
