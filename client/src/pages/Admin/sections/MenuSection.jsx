                  ...
                  <tr key={menu._id} className="hover:bg-background-muted/30 transition-colors group align-middle">
                    ...
                    <td className="px-3 py-4 text-center">
                      <div className="flex justify-center">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider border ${menu.foodType === 'veg'
                          ...
                          : 'bg-status-unavailable/5 text-status-unavailable border-status-unavailable/20'
                          }`}>
                          {menu.foodType}
                        </span>
                      </div>
                    ...
                    <td className="px-3 py-4">
                      <div className="flex flex-col space-y-2">
                        ...
                        {menu.hasOffer && (
                          <div className="flex items-center space-x-1.5 px-2 py-0.5 bg-status-available/5 border border-status-available/10 rounded-md w-fit">
                    ...
                    <td className="px-3 py-4 text-center">
                      <div className="flex flex-col items-center">
                        {menu.totalStock > 0 ? (
                          ...
                          <span className="text-[9px] font-black text-status-unavailable uppercase bg-status-unavailable/10 px-2 py-1 rounded border border-status-unavailable/20">
                            Out of Stock
                          </span>
                        )}
                      </div>
                    ...
                    <td className="px-3 py-4 text-center">
                      <div className="flex justify-center">
                        <span className={`flex items-center space-x-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border ${!menu.isBlocked
                          ...
                          : 'bg-status-unavailable/10 text-status-unavailable border-status-unavailable/30'
                          }`}>
                    ...
                    <td className="px-3 py-4 text-center">
                      <div className="flex items-center justify-center space-x-1">
                        ...
                        <button
                          ...
                          className="p-2 text-text-secondary hover:text-status-unavailable hover:bg-status-unavailable/10 rounded-xl transition-all duration-200"
                          title="Delete Item"
                        >
                          <Trash2 size={16} />
                        </button>
                    ...
                    <div key={idx} className="group/variant bg-background-muted/30 p-4 rounded-2xl border border-border-light space-y-4 animate-in slide-in-from-top-2 duration-300">
                      <div className="flex items-center justify-between border-b border-border-light pb-2">
                        ...
                        <button
                          ...
                          className="p-1.5 text-text-muted hover:text-status-unavailable hover:bg-status-unavailable/10 rounded-lg transition-all"
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                        ...
                        <div className="space-y-2">
                          <label className="text-[10px] font-bold text-text-secondary uppercase tracking-wider ml-1">Price (₹)</label>
                          <input
                            type="number"
                        ...
                        <div className="space-y-2">
                          <label className="text-[10px] font-bold text-text-secondary uppercase tracking-wider ml-1">Stock Mult.</label>
                          <input
                            type="number"
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <label className="text-[10px] font-bold text-text-secondary uppercase tracking-wider ml-1">Included Items (Add-ons)</label>
                          <button
                            type="button"
                        ...
                        <div className="space-y-2">
                          {variant.includedItems?.map((inc, iIdx) => (
                            <div key={iIdx} className="flex items-center space-x-2 bg-background-card p-2 rounded-lg border border-border-main">
                              <select
                                value={inc.menuItem}
                                onChange={(e) => handleIncludedItemChange(idx, iIdx, 'menuItem', e.target.value)}
                              ...
                              <input
                                type="number"
                                value={inc.quantity}
                                onChange={(e) => handleIncludedItemChange(idx, iIdx, 'quantity', e.target.value)}
                                className="w-12 bg-transparent text-[10px] text-center outline-none border-l border-border-main"
                              />
                              <button
                                type="button"
                                onClick={() => handleRemoveIncludedItem(idx, iIdx)}
